...
function getObjectEnumsSync(context, idObj, enumIds, enumNames) {
    ...
    for (let i = 0, l = context.enums.length; i < l; i++) {
        if (
            context.objects[context.enums[i]] &&
            ...
            if (enumNames.indexOf(context.objects[context.enums[i]].common.name) === -1)
                enumNames.push(context.objects[context.enums[i]].common.name);
        }
    }
        ...
        const eventObjectProperties = {
            ...
            channelName: {
                get: function () {
                    ...
                    const ret =
                        channelId && context.objects[channelId].common ? context.objects[channelId].common.name : null;
            ...
            deviceName: {
                get: function () {
                    ...
                    const ret =
                        deviceId && context.objects[deviceId].common ? context.objects[deviceId].common.name : null;
