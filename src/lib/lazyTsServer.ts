import { Server } from 'virtual-tsc';
import type { CompilerOptions } from 'typescript';
import type { CompileResult } from 'virtual-tsc/build/util';
import type { LoggerFunction } from 'virtual-tsc/build/logger';
 ...
 */
export class LazyTsServer {
    private server: Server | null = null;
    private options: CompilerOptions;
    private readonly logger: LoggerFunction | false | undefined;
     ...
     */
    constructor(options: CompilerOptions, logger?: LoggerFunction | false, releaseAfterMs = 0) {
     ...
     */
    provideAmbientDeclarations(declarations: Record<string, string>): void {
    ...
    releaseMemory(): void {
        ...
        const service = (this.server as unknown as { service?: { cleanupSemanticCache?: () => void } }).service;
     ...
     */
    forgetDeclarations(fileNames: string[]): void {
