...
exports.FB_CATEGORIES = exports.FB_LIBRARY = exports.FB_ASTRO_EVENTS = void 0;
...
exports.FB_LIBRARY = [
    ...
    // ---- calendar
    {
        ...
        stateful: true,
        timeDependent: true,
        code: '{I}.run(); {TOD} = {I}.TOD; {HOUR} = {I}.HOUR; {MIN} = {I}.MIN; {WDAY} = {I}.WDAY; ' +
    ...
    },
    {
        ...
        params: [
            { id: 'start', type: 'ENUM', options: exports.FB_ASTRO_EVENTS, default: 'sunset' },
            { id: 'startOffset', type: 'INT', default: 0 },
            { id: 'end', type: 'ENUM', options: exports.FB_ASTRO_EVENTS, default: 'sunrise' },
            { id: 'endOffset', type: 'INT', default: 0 },
        ],
        timeDependent: true,
        code: '{START} = rt.astro({$start}, {$startOffset}); {END} = rt.astro({$end}, {$endOffset}); ' +
...
const byType = new Map(exports.FB_LIBRARY.map(def => [def.type, def]));
...
function getTerminals(user, type) {
...
function isTimeDependent(user, userBlocks, seen) {
    seen.add(user.type);
 ...
 */
function userBlockDef(user, userBlocks) {
    return {
        type: user.type,
        category: 'user',
 ...
 */
function getBlockDef(type, userBlocks) {
