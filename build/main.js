...
class JavaScript extends adapter_core_1.Adapter {
     ...
     */
    secretsManager = new secrets_1.SecretsManager(this);
    globalScript = '';
    ...
    onMessage(obj) {
        switch (obj?.command) {
            ...
            case 'fbdWatch': {
                ...
                const { script, watch, full, path } = (obj.message || {});
                if (typeof script === 'string') {
                    if (watch) {
                        ...
                        const paths = current?.paths || new Map();
            ...
            case 'fbdDebug': {
                ...
                const { script, ...command } = (obj.message || {});
