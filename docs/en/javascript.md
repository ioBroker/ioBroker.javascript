...
Node.js uses /bin/sh to execute commands. If you want to use another shell you can us ethe options object as described in the Node.js documentation for child_process.exec.
