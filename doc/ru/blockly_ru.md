...
## Пример 3
**Отправить электронное сообщение, если температура на улице превышает 25 градусов Цельсия.**
...
Если температура менее 23 градусов, сбросьте флаг «emailSent», чтобы отправить электронное письмо, оповещая о температуре.
Мы сравниваем температуру с 23, чтобы не отправлять электронные письма каждый раз, если температура колеблется около 25 градусов.
