import{Ar as e,Dr as t,Et as n,Gt as r,Ht as i,Jn as a,Jt as o,Kt as s,Pr as c,Tn as l,Tt as u,Wt as d,an as f,ar as p,kr as m,ln as ee,m as h,on as g,or as _,sn as te,sr as v,wr as y,xn as b,yn as x}from"./_virtual_mf___mfe_internal__iobroker_javascript__mf_owner__180366418666083__loadShare___mf_0_iobroker_mf_1_gui_mf_2_components__loadShare__.js-CIbrWfKm.js";var S=a([_(`path`,{d:`M21 5c-1.11-.35-2.33-.5-3.5-.5-1.95 0-4.05.4-5.5 1.5-1.45-1.1-3.55-1.5-5.5-1.5S2.45 4.9 1 6v14.65c0 .25.25.5.5.5.1 0 .15-.05.25-.05C3.1 20.45 5.05 20 6.5 20c1.95 0 4.05.4 5.5 1.5 1.35-.85 3.8-1.5 5.5-1.5 1.65 0 3.35.3 4.75 1.05.1.05.15.05.25.05.25 0 .5-.25.5-.5V6c-.6-.45-1.25-.75-2-1m0 13.5c-1.1-.35-2.3-.5-3.5-.5-1.7 0-4.15.65-5.5 1.5V8c1.35-.85 3.8-1.5 5.5-1.5 1.2 0 2.4.15 3.5.5z`},`0`),_(`path`,{d:`M17.5 10.5c.88 0 1.73.09 2.5.26V9.24c-.79-.15-1.64-.24-2.5-.24-1.7 0-3.24.29-4.5.83v1.66c1.13-.64 2.7-.99 4.5-.99M13 12.49v1.66c1.13-.64 2.7-.99 4.5-.99.88 0 1.73.09 2.5.26V11.9c-.79-.15-1.64-.24-2.5-.24-1.7 0-3.24.3-4.5.83m4.5 1.84c-1.7 0-3.24.29-4.5.83v1.66c1.13-.64 2.7-.99 4.5-.99.88 0 1.73.09 2.5.26v-1.52c-.79-.16-1.64-.24-2.5-.24`},`1`)],`MenuBook`);c();var C=/^(#{1,6})\s+(.*?)\s*#*\s*$/,w=/^\s*```/,T=/^(\s*)[-*+]\s+(.*)$/,E=/^(\s*)(\d+)\.\s+(.*)$/,D=/^\s*\|?\s*:?-+:?\s*(\|\s*:?-+:?\s*)*\|?\s*$/,O=/`([^`]+)`|\\([!-/:-@[-`{-~])|\*\*\*(\S(?:.*?\S)??)\*\*\*|\*\*(\S(?:.*?\S)??)\*\*|\*([^*\s](?:[^*]*?[^*\s])?)\*|\[([^\]]+)\]\(([^)\s]+)\)|(https?:\/\/[^\s<>()`]*[^\s<>()`.,;:!?'"*])/g;function k(e){let t=[],n=new RegExp(O.source,`g`),r=0,i,a=e=>{let n=t[t.length-1];(n==null?void 0:n.type)===`text`?n.text+=e:e&&t.push({type:`text`,text:e})};for(;(i=n.exec(e))!==null;){a(e.slice(r,i.index));let[,n,o,s,c,l,u,d,f]=i;n===void 0?o===void 0?s===void 0?c===void 0?l===void 0?f===void 0?t.push({type:`link`,href:d,children:k(u)}):t.push({type:`link`,href:f,children:[{type:`text`,text:f}]}):t.push({type:`em`,children:k(l)}):t.push({type:`strong`,children:k(c)}):t.push({type:`strong`,children:[{type:`em`,children:k(s)}]}):a(o):t.push({type:`code`,text:n}),r=i.index+i[0].length}return a(e.slice(r)),t}function A(e){return(typeof e==`string`?k(e):e).map(e=>`children`in e?A(e.children):e.text).join(``)}function j(e,t){let n=e.toLowerCase().replace(/[^\p{L}\p{M}\p{N}\p{Pc} -]/gu,``).replace(/ /g,`-`),r=n;for(;t.has(r);){let e=(t.get(n)||0)+1;t.set(n,e),r=`${n}-${e}`}return t.set(r,0),r}function M(e){return e.trim().replace(/^\|/,``).replace(/(?<!\\)\|$/,``).split(/(?<!\\)\|/).map(e=>e.trim())}function N(e,t){return e[t].trim().startsWith(`|`)&&D.test(e[t+1]||``)}function P(e,t){let n=e[t];return C.test(n)||w.test(n)||N(e,t)||T.test(n)||E.test(n)}var F=e=>e.replace(/\t/g,`    `).length;function I(e){let t=e.split(/\r?\n/),n=[],r=new Map;for(let e=0;e<t.length;e++){let i=t[e];if(!i.trim())continue;if(w.test(i)){let r=[];for(e++;e<t.length&&!w.test(t[e]);e++)r.push(t[e]);n.push({type:`code`,text:r.join(`
`)});continue}let a=C.exec(i);if(a){let e=A(a[2]);n.push({type:`heading`,level:a[1].length,source:a[2],text:e,anchor:j(e,r)});continue}if(N(t,e)){let r=M(i),a=[];for(e+=2;e<t.length&&t[e].trim().startsWith(`|`);e++)a.push(M(t[e]));e--,n.push({type:`table`,header:r,rows:a});continue}let o=E.exec(i);if(o||T.test(i)){let r=!!o,a=r?E:T,s=F((o||T.exec(i))[1]),c=[];for(;e<t.length&&t[e].trim();e++){let n=a.exec(t[e]);if(n){let e=F(n[1]);c.push({text:n[n.length-1],depth:e>s?Math.ceil((e-s)/4):0})}else if(P(t,e))break;else c[c.length-1].text+=` ${t[e].trim()}`}e--,n.push({type:`list`,ordered:r,start:o?parseInt(o[2],10):1,items:c});continue}let s=[i.trim()];for(e++;e<t.length&&t[e].trim()&&!P(t,e);e++)s.push(t[e].trim());e--,n.push({type:`paragraph`,text:s.join(` `)})}return n}function L(e){let t=e.findIndex(e=>e.type===`heading`&&/^((table of )?contents?|inhalt(sverzeichnis)?)$/i.test(e.text.trim()));if(t===-1)return e;let{level:n}=e[t],r=t+1;for(;r<e.length&&!(e[r].type===`heading`&&e[r].level<=n);){if(e[r].type!==`list`)return e;r++}return[...e.slice(0,t),...e.slice(r)]}var R=/^([A-Za-z_$][\w$]*)(?:\s+-\s+(.*))?$/;function z(e){return e.filter(e=>e.type===`heading`&&e.level<=3).map(e=>{let t=e.text.replace(/:\s*$/,``),n=e.level>=3?R.exec(t):null;return{level:e.level,anchor:e.anchor,name:n?n[1]:t,description:(n==null?void 0:n[2])||``,text:t,code:!!n}})}function ne(e,t){if(!t)return null;let n=e.find(e=>e.level>=3&&e.name===t);return n?n.anchor:null}function re(e,t){let n=t.toLowerCase().split(/\s+/).filter(Boolean);return n.length?e.filter(e=>{let t=e.text.toLowerCase();return n.every(e=>t.includes(e))}):e}function ie(e,t){return e.startsWith(`#`)?{anchor:decodeURIComponent(e.slice(1)).toLowerCase()}:/^[a-z][a-z\d+.-]*:/i.test(e)?{url:e}:{url:new URL(e,t).href}}var B=`doc-`,V={fontFamily:`ui-monospace, "Cascadia Code", Consolas, monospace`,fontSize:`0.85em`,px:.6,py:.15,borderRadius:.5,bgcolor:`action.hover`},H={1:{fontSize:`1.6rem`,fontWeight:500,mt:0,mb:1.5},2:{fontSize:`1.4rem`,fontWeight:500,mt:5,mb:1,pb:.5,borderBottom:1,borderColor:`divider`},3:{fontSize:`1.15rem`,fontWeight:600,mt:4,mb:.75},4:{fontSize:`1rem`,fontWeight:600,mt:2.5,mb:.5},5:{fontSize:`0.95rem`,fontWeight:600,mt:2,mb:.5},6:{fontSize:`0.9rem`,fontWeight:600,mt:2,mb:.5}};function U(e,t,n){return e.map((e,r)=>{let i=`${t}-${r}`;switch(e.type){case`text`:return e.text;case`code`:return _(s,{component:`code`,sx:V,children:e.text},i);case`strong`:return _(`strong`,{children:U(e.children,i,n)},i);case`em`:return _(`em`,{children:U(e.children,i,n)},i);case`link`:{let t=ie(e.href,n.base);return`anchor`in t?_(l,{href:`#${t.anchor}`,onClick:e=>{e.preventDefault(),n.onAnchor(t.anchor)},children:U(e.children,i,n)},i):_(l,{href:t.url,target:`_blank`,rel:`noreferrer`,children:U(e.children,i,n)},i)}default:return null}})}function W(e){let t=(t,n)=>U(k(t),n,e);return _(p,{children:e.blocks.map((e,n)=>{let i=`b${n}`;switch(e.type){case`heading`:return _(r,{id:`${B}${e.anchor}`,"data-level":e.level,component:`h${e.level}`,sx:{...H[e.level],...n===0?{mt:0}:void 0,scrollMarginTop:12},children:t(e.source,i)},i);case`paragraph`:return _(r,{sx:{my:1.25,lineHeight:1.65},children:t(e.text,i)},i);case`code`:return _(s,{component:`pre`,sx:{...V,px:1.5,py:1.25,my:1.5,overflowX:`auto`,fontSize:12.5,lineHeight:1.5,border:1,borderColor:`divider`},children:e.text},i);case`table`:return _(s,{sx:{my:1.5,overflowX:`auto`},children:v(s,{component:`table`,sx:{borderCollapse:`collapse`,width:`100%`,fontSize:14,"& td, & th":{border:1,borderColor:`divider`,px:1,py:.6,textAlign:`left`,verticalAlign:`top`},"& th":{bgcolor:`action.hover`,fontWeight:500}},children:[e.header.some(e=>e)?_(`thead`,{children:_(`tr`,{children:e.header.map((e,n)=>_(`th`,{children:t(e,`${i}h${n}`)},n))})}):null,_(`tbody`,{children:e.rows.map((e,n)=>_(`tr`,{children:e.map((e,r)=>_(`td`,{children:t(e,`${i}r${n}c${r}`)},r))},n))})]})},i);case`list`:return _(s,{component:e.ordered?`ol`:`ul`,start:e.ordered&&e.start!==1?e.start:void 0,sx:{my:1.25,pl:3,lineHeight:1.65,"& li":{mb:.5}},children:e.items.map((e,n)=>_(s,{component:`li`,sx:e.depth?{ml:e.depth*3}:void 0,children:t(e.text,`${i}i${n}`)},n))},i);default:return null}})})}var G=`## Content
...
`;c();var q={en:G,de:K},J=`https://github.com/ioBroker/ioBroker.javascript/blob/master/docs/`,Y=`Editor.docScroll`,X=`Editor.docContents`,ae=1500,oe=`ui-monospace, "Cascadia Code", Consolas, monospace`,Z={};function se(e){let t=q[e]?e:`en`;if(!Z[t]){let e=L(I(q[t]));Z[t]={lang:t,blocks:e,entries:z(e)}}return Z[t]}function Q(e){try{return window.localStorage.getItem(e)}catch{return null}}function $(e,t){try{window.localStorage.setItem(e,t)}catch{}}function ce({onClose:a,word:c}){let{lang:l,blocks:p,entries:C}=se(h.getLanguage()),w=`${Y}.${l}`,T=m(null),E=m(null),D=m(0),O=m(null),[k,A]=e(()=>Q(X)!==`false`),[j,M]=e(``),[N,P]=e(``),F=t(()=>re(C,j),[C,j]),I=()=>{let e=T.current;if(!e)return;let t=e.scrollTop+24,n=``;for(let r of Array.from(e.querySelectorAll(`[data-level]`)))if(!(Number(r.dataset.level)>3)){if(r.offsetTop>t)break;n=r.id.substring(B.length)}e.scrollTop+e.clientHeight>=e.scrollHeight-4&&O.current&&Date.now()-O.current.at<ae&&(n=O.current.anchor),P(n)},L=(e,t=!0)=>{var n;let r=(n=T.current)==null?void 0:n.querySelector(`#${CSS.escape(B+e)}`);r&&(O.current={anchor:e,at:Date.now()},P(e),r.scrollIntoView({block:`start`,behavior:t?`smooth`:`auto`}))};y(()=>{let e=ne(C,c),t=Number(Q(w)),n=0,r=requestAnimationFrame(()=>{n=requestAnimationFrame(()=>{e?L(e,!1):T.current&&Number.isFinite(t)&&t>0&&(T.current.scrollTop=t),I()})});return()=>{cancelAnimationFrame(r),cancelAnimationFrame(n),cancelAnimationFrame(D.current)}},[]),y(()=>{if(N){var e;(e=E.current)==null||(e=e.querySelector(`[data-anchor="${CSS.escape(N)}"]`))==null||e.scrollIntoView({block:`nearest`})}},[N,k]);let R=()=>{D.current||=requestAnimationFrame(()=>{var e;D.current=0,$(w,String(((e=T.current)==null?void 0:e.scrollTop)||0)),I()})},z=t(()=>_(W,{blocks:p,base:`${J}${l}/`,onAnchor:e=>L(e)}),[p,l]);return v(f,{open:!0,fullWidth:!0,maxWidth:`lg`,onClose:a,slotProps:{paper:{sx:{height:`calc(100% - 64px)`}}},children:[v(ee,{sx:{display:`flex`,alignItems:`center`,gap:1,pb:1},children:[_(d,{title:h.t(`Contents`),slotProps:{popper:{sx:{pointerEvents:`none`}}},children:_(x,{size:`small`,color:k?`primary`:`default`,onClick:()=>{$(X,String(!k)),A(!k)},children:_(S,{})})}),h.t(`Documentation`)]}),v(te,{dividers:!0,sx:{display:`flex`,p:0,minHeight:0},children:[k?v(s,{sx:{flex:`0 0 280px`,minWidth:0,display:`flex`,flexDirection:`column`,minHeight:0,borderRight:1,borderColor:`divider`},children:[_(s,{sx:{p:1},children:_(i,{autoFocus:!0,fullWidth:!0,size:`small`,variant:`outlined`,placeholder:h.t(`Filter`),value:j,onChange:e=>M(e.target.value),onKeyDown:e=>{e.key===`Enter`&&F.length?L(F[0].anchor):e.key===`Escape`&&j&&(e.stopPropagation(),M(``))},slotProps:{input:{endAdornment:j?_(b,{position:`end`,children:_(x,{size:`small`,onClick:()=>M(``),children:_(n,{fontSize:`small`})})}):null}}})}),v(s,{ref:E,sx:{flex:1,overflowY:`auto`,pb:1},children:[F.map(e=>v(s,{"data-anchor":e.anchor,title:e.text,onClick:()=>L(e.anchor),sx:{display:`flex`,alignItems:`baseline`,gap:1,pl:e.level<3?1.5:3,pr:1,py:.4,mt:+(e.level<3&&!j),cursor:`pointer`,fontSize:e.level<3?14:13,fontWeight:e.level<3?500:400,color:e.anchor===N?`primary.main`:`text.primary`,bgcolor:e.anchor===N?`action.selected`:void 0,"&:hover":{bgcolor:`action.hover`}},children:[_(s,{component:`span`,sx:{flexShrink:+!e.code,fontFamily:e.code?oe:void 0,overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:e.code?`nowrap`:void 0,maxWidth:`100%`},children:e.name}),e.description?_(s,{component:`span`,sx:{minWidth:0,fontSize:12,color:`text.secondary`,overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`},children:e.description}):null]},e.anchor)),F.length?null:_(r,{sx:{px:1.5,py:1,fontSize:13,color:`text.secondary`},children:h.t(`Nothing found`)})]})]}):null,_(s,{ref:T,onScroll:R,sx:{flex:1,minWidth:0,overflowY:`auto`,position:`relative`,px:3,py:2},children:z})]}),_(g,{children:_(o,{variant:`contained`,color:`grey`,startIcon:_(u,{}),onClick:a,children:h.t(`Close`)})})]})}export{ce as default};