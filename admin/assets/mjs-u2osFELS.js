...
/* ====== */`);var g=a.forwardRef((({className:e,theme:t,draggerClassName:n,direction:i=S.Vertical,onDragging:a},o)=>{let s=`__dbk__gutter ${i} ${e||t}`,c=`__dbk__dragger ${i} ${n||t}`;return r(`div`,Object.assign({className:s,ref:o,dir:i,onMouseDown:a,onTouchStart:w?a:void 0},{children:r(`div`,{className:c},void 0)}),void 0)})),_;function v(e,t,n){let r,i;return t?(r=e/2,i=e):n?(r=e,i=e/2):(r=e,i=e),{aGutterSize:r,bGutterSize:i}}function y(e,t){switch(t.type){case _.SetIsReadyToCompute:return Object.assign(Object.assign({},e),{isReady:t.payload.isReady});case _.CreatePairs:{let{direction:n,children:r,gutters:i}=t.payload,a=r[0].parentNode;if(!a)throw Error(`Cannot create pairs - parent is undefined.`);let o=m(n,a);if(o===void 0)throw Error(`Cannot create pairs - parent has undefined or zero size: ${o}.`);let s=[];return r.forEach(((e,t)=>{if(t>0){let e=r[t-1],o=r[t],c=i[t-1],l=n===S.Horizontal?e.getBoundingClientRect().left:e.getBoundingClientRect().top,u=n===S.Horizontal?o.getBoundingClientRect().right:o.getBoundingClientRect().bottom,d=n===S.Horizontal?e.getBoundingClientRect().width+c.getBoundingClientRect().width+o.getBoundingClientRect().width:e.getBoundingClientRect().height+c.getBoundingClientRect().height+o.getBoundingClientRect().height,f=n===S.Horizontal?c.getBoundingClientRect().width:c.getBoundingClientRect().height,p={idx:t-1,a:e,b:o,gutter:c,parent:a,start:l,end:u,size:d,gutterSize:f,aSizePct:100/r.length,bSizePct:100/r.length};s.push(p)}})),Object.assign(Object.assign({},e),{pairs:s})}case _.StartDragging:{let{gutterIdx:n}=t.payload;return Object.assign(Object.assign({},e),{isDragging:!0,draggingIdx:n})}case _.StopDragging:return Object.assign(Object.assign({},e),{isDragging:!1});case _.CalculateSizes:{let{direction:n,gutterIdx:r}=t.payload,i=e.pairs[r],a=m(n,i.parent);if(!a)throw Error(`Cannot calculate sizes - 'pair.parent' has undefined or zero size.`);let o=i.gutter[n===S.Horizontal?`clientWidth`:`clientHeight`],{aGutterSize:s,bGutterSize:c}=v(o,r===0,r===e.pairs.length-1),l,u,d,f,p;return n===S.Horizontal?(l=i.a.getBoundingClientRect().left,u=i.b.getBoundingClientRect().right,f=(i.a.getBoundingClientRect().width+s)/a*100,p=(i.b.getBoundingClientRect().width+c)/a*100,d=i.a.getBoundingClientRect().width+s+c+i.b.getBoundingClientRect().width):(l=i.a.getBoundingClientRect().top,u=i.b.getBoundingClientRect().bottom,f=(i.a.getBoundingClientRect().height+s)/a*100,p=(i.b.getBoundingClientRect().height+c)/a*100,d=i.a.getBoundingClientRect().height+s+c+i.b.getBoundingClientRect().height),e.pairs[r]=Object.assign(Object.assign({},i),{start:l,end:u,size:d,aSizePct:f,bSizePct:p,gutterSize:o}),Object.assign({},e)}default:return e}}function b(e,r=0,i=[]){return n.toArray(e).reduce(((e,n,a)=>((0,p.isFragment)(n)?e.push.apply(e,b(n.props.children,r+1,i.concat(n.key||a))):o(n)?e.push(t(n,{key:i.concat(String(n.key)).join(`.`)})):typeof n!=`string`&&typeof n!=`number`||e.push(n),e)),[])}(function(e){e[e.SetIsReadyToCompute=0]=`SetIsReadyToCompute`,e[e.CreatePairs=1]=`CreatePairs`,e[e.CalculateSizes=2]=`CalculateSizes`,e[e.StartDragging=3]=`StartDragging`,e[e.StopDragging=4]=`StopDragging`})(_||={});var x=e=>`changedTouches`in e,S,C;(function(e){e.Horizontal=`Horizontal`,e.Vertical=`Vertical`})(S||={}),function(e){e.Light=`Light`,e.Dark=`Dark`}(C||={});var w=typeof window<`u`&&`ontouchstart`in window;function T(e){return e===S.Horizontal?`col-resize`:`row-resize`}var E={isReady:!1,isDragging:!1,pairs:[]};function D({direction:e=S.Horizontal,minWidths:t=[],minHeights:n=[],initialSizes:o,gutterTheme:u=C.Dark,gutterClassName:d,draggerClassName:f,children:p,onResizeStarted:D,onResizeFinished:O,classes:k=[]}){let A=b(p),[j,M]=l(y,E),N=c(null),P=c([]),F=c([]);P.current=[],F.current=[];let I=a.useCallback((e=>{M({type:_.SetIsReadyToCompute,payload:{isReady:e}})}),[]),L=a.useCallback(((e,t)=>{M({type:_.StartDragging,payload:{gutterIdx:t}});let n=j.pairs[t];D==null||D(n.idx),n.a.style.userSelect=`none`,n.b.style.userSelect=`none`,n.gutter.style.cursor=T(e),n.parent.style.cursor=T(e),document.body.style.cursor=T(e)}),[j.pairs]),R=a.useCallback((()=>{M({type:_.StopDragging});let t=[];for(let n=0;n<j.pairs.length;n++){let r=j.pairs[n],i=m(e,r.parent);if(i===void 0)throw Error(`Cannot call the 'onResizeFinished' callback - parentSize is undefined`);if(r.gutterSize===void 0)throw Error(`Cannot call 'onResizeFinished' callback - gutterSize is undefined`);let a=n===0,o=n===j.pairs.length-1,s=r.a.getBoundingClientRect()[e===S.Horizontal?`width`:`height`],{aGutterSize:c,bGutterSize:l}=v(r.gutterSize,a,o),u=(s+c)/i*100;if(t.push(u),o){let n=(r.b.getBoundingClientRect()[e===S.Horizontal?`width`:`height`]+l)/i*100;t.push(n)}}if(j.draggingIdx===void 0)throw Error(`Could not reset cursor and user-select because 'state.draggingIdx' is undefined`);let n=j.pairs[j.draggingIdx];O==null||O(n.idx,t),n.a.style.userSelect=``,n.b.style.userSelect=``,n.gutter.style.cursor=``,n.parent.style.cursor=``,document.body.style.cursor=``}),[j.draggingIdx,j.pairs,e]),z=a.useCallback(((e,t)=>{M({type:_.CalculateSizes,payload:{direction:e,gutterIdx:t}})}),[]),B=a.useCallback(((e,t,n)=>{M({type:_.CreatePairs,payload:{direction:e,children:t,gutters:n}})}),[]),V=a.useCallback(((e,t,n,r)=>{let i=t[0].parentNode;if(!i)throw Error(`Cannot set initial sizes - parent is undefined`);if(m(e,i)===void 0)throw Error(`Cannot set initial sizes - parent has undefined size`);t.forEach(((i,a)=>{let o=a===0,s=a===t.length-1,c,l=0;t.length>1&&(l=n[s?a-1:a].getBoundingClientRect()[e===S.Horizontal?`width`:`height`],l=o||s?l/2:l),c=r&&a<r.length?`calc(${r[a]}% - ${l}px)`:`calc(${100/t.length}% - ${l}px)`,e===S.Horizontal?(i.style.width=c,i.style.height=`100%`):(i.style.height=c,i.style.width=`100%`)}))}),[]),H=a.useCallback(((e,t)=>{if(j.draggingIdx===void 0)throw Error(`Cannot adjust size - 'draggingIdx' is undefined`);let n=j.pairs[j.draggingIdx];if(n.size===void 0)throw Error(`Cannot adjust size - 'pair.size' is undefined`);if(n.gutterSize===void 0)throw Error(`Cannot adjust size - 'pair.gutterSize' is undefined`);let r=n.aSizePct+n.bSizePct,i=t/n.size*r,a=r-t/n.size*r,o=j.draggingIdx===0,s=j.draggingIdx===j.pairs.length-1,{aGutterSize:c,bGutterSize:l}=v(n.gutterSize,o,s),u=`calc(${i}% - ${c}px)`,d=`calc(${a}% - ${l}px)`;e===S.Horizontal?(n.a.style.width=u,n.b.style.width=d):(n.a.style.height=u,n.b.style.height=d)}),[j.draggingIdx,j.pairs,e]),U=a.useCallback(((e,t,n)=>{if(!j.isDragging)return;if(j.draggingIdx===void 0)throw Error(`Cannot drag - 'draggingIdx' is undefined`);let r=j.pairs[j.draggingIdx];if(r.start===void 0)throw Error(`Cannot drag - 'pair.start' is undefined`);if(r.size===void 0)throw Error(`Cannot drag - 'pair.size' is undefined`);if(r.gutterSize===void 0)throw Error(`Cannot drag - 'pair.gutterSize' is undefined`);let i=function(e,t){let n=x(t)?t.changedTouches[0]:t;return e===S.Horizontal?n.clientX:n.clientY}(t,e)-r.start,a=16,o=16;n.length>j.draggingIdx&&(a=n[j.draggingIdx]),n.length>=j.draggingIdx+1&&(o=n[j.draggingIdx+1]),i<r.gutterSize+a&&(i=r.gutterSize+a),i>=r.size-(r.gutterSize+o)&&(i=r.size-(r.gutterSize+o)),H(t,i)}),[j.isDragging,j.draggingIdx,j.pairs,H]),W=()=>{if(j.isDragging){if(j.draggingIdx===void 0)throw Error(`Cannot calculate sizes after dragging = 'state.draggingIdx' is undefined`);z(e,j.draggingIdx),R()}},G=r=>{j.isDragging&&(x(r)&&r.preventDefault(),U(r,e,e===S.Horizontal?t:n))};function K(e,t){if(!e.current)throw Error(`Can't add element to ref object - ref isn't initialized`);t&&!e.current.includes(t)&&e.current.push(t)}return h(`mouseup`,W,[j.isDragging,R]),h(`mousemove`,G,[e,j.isDragging,U,t,n]),h(`touchend`,W,[j.isDragging,R],{condition:w}),h(`touchmove`,G,[e,j.isDragging,U,t,n],{condition:w,passive:!w}),s((function(){if(!N.current)return;let t=N.current.parentElement;if(!t)return;let n=new ResizeObserver((()=>{let n=getComputedStyle(t),r=e===S.Horizontal?t.clientWidth:t.clientHeight;I(!!n&&!!r)}));return n.observe(t),()=>{n.disconnect()}}),[N.current,e]),s((function(){if(j.isReady&&(!P.current||P.current[0].offsetParent)){if(!P.current||!F.current)throw Error(`Cannot create pairs - either variable 'childRefs' or 'gutterRefs' is undefined`);A.length<=1?V(e,P.current,F.current,o):(V(e,P.current,F.current,o),B(e,P.current,F.current))}}),[p,j.isReady,e,V,B,o]),r(`div`,Object.assign({className:`__dbk__container ${e}`,ref:N},{children:j.isReady&&A.map(((t,n)=>i(a.Fragment,{children:[r(`div`,Object.assign({ref:e=>K(P,e),className:`__dbk__child-wrapper `+(n<k.length?k[n]:``)},{children:t}),void 0),n<A.length-1&&r(g,{ref:e=>K(F,e),className:d,theme:u,draggerClassName:f,direction:e,onDragging:()=>{z(e,t=n),L(e,t);return;var t}},void 0)]},n)))}),void 0)}export{S as n,D as t};